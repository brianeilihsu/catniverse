  ...
  const fetchFilteredProducts = async () => {
    ...
    try {
      ...
      if (noSearchCriteria) {
        ...
        try {
          response = await axios.get(
            `https://api.catniverse.website:5000/api/v1/products/products/by/category-and-brand`,
        ...
        try {
          response = await axios.get(
            `https://api.catniverse.website:5000/api/v1/products/products/by/brand-and-name`,
        ...
        response = await axios.get(
          `https://api.catniverse.website:5000/api/v1/products/products/${name}/products`
        );
      } else if (selectedCategory) {
        response = await axios.get(
          `https://api.catniverse.website:5000/api/v1/products/product/${selectedCategory}/all/products`
        );
      } else if (selectedBrand) {
        response = await axios.get(
          `https://api.catniverse.website:5000/api/v1/products/product/by-brand`,
