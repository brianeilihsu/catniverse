    ...
    <div>
      <form onSubmit={submitHandler}>
        <div>
          ...
          <select name="founded_city" value={cat.founded_city} onChange={handleInputChange}>
          ...
          <select name="founded_city" value={cat.founded_town} onChange={handleInputChange}>
            <option value="">選擇鄉鎮</option>
            {cat.founded_city &&
              TaiwanCitys[cat.founded_city].map((district) => (
